      ...
      if($_SESSION['permisosMod']['r']){
        ...
        for ($i=0; $i < count($arrData); $i++) {
          ...
          if ($_SESSION['permisosMod']['u']) {
            ...
            $btnEdit = '<button class="btn btn-success btn-sm btnEditRol" onClick="fntEditRol(this,'.$arrData[$i]['idrol'].')" title="Permisos"><i class="fas fa-pencil-alt"></i></button>';
          }
          if ($_SESSION['permisosMod']['d']) {
            $btnDelete = '<button class="btn btn-danger btn-sm btnDeleteRol" onClick="fntDeleteRol('.$arrData[$i]['idrol'].')" title="Permisos"><i class="fas fa-trash-alt"></i></button>';
          }
